...
#include "session.h"
using namespace std;
QString search_product_namev(QString search)
{
...
QString search_upper_limitv(QString search)
{
    std::string str_ = search.toUtf8().constData();
    std::string username = district_global.toUtf8().constData();
    std::string filename = "";
...
QString search_lower_limitv(QString search)
{
    std::string str_ = search.toUtf8().constData();
    std::string username = district_global.toUtf8().constData();
    std::string filename = "";
...
QString search_ind_limitv(QString search)
{
    std::string str_ = search.toUtf8().constData();
    std::string username = district_global.toUtf8().constData();
    std::string filename = "";
...
QString search_capv(QString search)
{
    std::string str_ = search.toUtf8().constData();
    std::string username = district_global.toUtf8().constData();
    std::string filename = "";
...
QString search_pricev(QString search)
{
    std::string str_ = search.toUtf8().constData();
    std::string username = district_global.toUtf8().constData();
    std::string filename = "";
...
int check_first3(std::string s1,std::string s2)
{
    ifstream ff;
    ff.open(s1);
    std::string s;
